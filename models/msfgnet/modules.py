...
class MRFE(nn.Layer):
    #multi-receptive field features extraction
    def __init__(self):
        super().__init__()
...
class Encoder(nn.Layer):
    ...
    def down_sampling(self, in_channels, out_channels, lksize):
        modules = []
        # modules.append(layers.ConvBNReLU(in_channels, out_channels, 3, stride=2, padding=1))
        # modules.append(LKBlock(out_channels, out_channels, lksize))
        # modules.append(FFN(out_channels, 4*out_channels, out_channels))
