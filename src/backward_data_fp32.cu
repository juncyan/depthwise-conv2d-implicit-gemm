...
// paddle::Tensor backward_data_fp32(
//     paddle::Tensor input,
...
//     cutlass::TensorRef<ElementFilter, LayoutFilter> d_filter((ElementFilter*)(weight.data<ElementFilter>()),
//         LayoutFilter().packed(options.filter_size));
//     cutlass::TensorRef<typename Convolution::ElementDst,
//                        typename Convolution::LayoutDst> d_dst((ElementDst*)(output.data<ElementDst>()),
