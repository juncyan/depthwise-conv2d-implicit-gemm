...
paddle::Tensor forward_fp16(paddle::Tensor input, paddle::Tensor weight) {
    ...
    auto output = paddle::experimental::zeros_like(weight, paddle::DataType::FLOAT16);
